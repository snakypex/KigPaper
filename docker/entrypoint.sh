#!/bin/bash
cd /home/container
java -Xms${SERVER_MEMORY} -Xmx${SERVER_MEMORY} -XX:+UseG1GC -XX:+ParallelRefProcEnabled -XX:MaxGCPauseMillis=200 -XX:+UnlockExperimentalVMOptions \
...
-XX:MaxTenuringThreshold=1 -jar Paperclip.jar
